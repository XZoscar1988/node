...
* [[`59dd83e156`](https://github.com/nodejs/node/commit/59dd83e156)] - doc/tools: fix more type inconsistencies (Roman Reiss) [#11697](https://github.com/nodejs/node/pull/11697)
* [[`a08cf4b239`](https://github.com/nodejs/node/commit/a08cf4b239)] - **async_wrap**: close the destroy_ids_idle_handle_ (René Schünemann) [#10385](https://github.com/nodejs/node/pull/10385)
* [[`0ae9583165`](https://github.com/nodejs/node/commit/0ae9583165)] - **benchmark**: terminate child process on Windows (Rich Trott) [#12658](https://github.com/nodejs/node/pull/12658)
...
* [[`16f78f89f5`](https://github.com/nodejs/node/commit/16f78f89f5)] - **build**: fix case in lib names (Refael Ackermann) [#12522](https://github.com/nodejs/node/pull/12522)
* [[`f66692aee3`](https://github.com/nodejs/node/commit/f66692aee3)] - **build**: make linter targets silent (Sakthipriyan Vairamani (thefourtheye)) [#12423](https://github.com/nodejs/node/pull/12423)
* [[`b179b26951`](https://github.com/nodejs/node/commit/b179b26951)] - **build**: don't create directory for NDK toolchain (TheBeastOfCaerbannog) [#11916](https://github.com/nodejs/node/pull/11916)
* [[`d345b7bbd6`](https://github.com/nodejs/node/commit/d345b7bbd6)] - **(SEMVER-MINOR)** **build**: support for mips64el (nanxiongchao) [#10991](https://github.com/nodejs/node/pull/10991)
* [[`1646c6a343`](https://github.com/nodejs/node/commit/1646c6a343)] - **build**: run cpplint even if jslint failed (Ruslan Bekenev) [#12276](https://github.com/nodejs/node/pull/12276)
...
* [[`ae95a3b1c1`](https://github.com/nodejs/node/commit/ae95a3b1c1)] - **(SEMVER-MINOR)** **cluster**: return worker reference from disconnect() (Sean Villars) [#10019](https://github.com/nodejs/node/pull/10019)
* [[`708b97845a`](https://github.com/nodejs/node/commit/708b97845a)] - **(SEMVER-MINOR)** **crypto**: ability to select cert store at runtime (Adam Majer) [#8334](https://github.com/nodejs/node/pull/8334)
* [[`e3ef382f35`](https://github.com/nodejs/node/commit/e3ef382f35)] - **(SEMVER-MINOR)** **crypto**: Use system CAs instead of using bundled ones (Adam Majer) [#8334](https://github.com/nodejs/node/pull/8334)
* [[`4a623fe110`](https://github.com/nodejs/node/commit/4a623fe110)] - **(SEMVER-MINOR)** **crypto**: do not use pointers to std::vector (Adam Majer) [#8334](https://github.com/nodejs/node/pull/8334)
* [[`a69bed5c46`](https://github.com/nodejs/node/commit/a69bed5c46)] - **(SEMVER-MINOR)** **crypto**: return `this` in setAuthTag/setAAD (Kirill Fomichev) [#9398](https://github.com/nodejs/node/pull/9398)
* [[`0fc4955776`](https://github.com/nodejs/node/commit/0fc4955776)] - **(SEMVER-MINOR)** **crypto**: support OPENSSL_CONF again (Sam Roberts) [#11006](https://github.com/nodejs/node/pull/11006)
* [[`b1dc123f0c`](https://github.com/nodejs/node/commit/b1dc123f0c)] - **crypto**: make LazyTransform compabile with Streams1 (Matteo Collina) [#12380](https://github.com/nodejs/node/pull/12380)
...
* [[`f75bf0f02c`](https://github.com/nodejs/node/commit/f75bf0f02c)] - **(SEMVER-MINOR)** **deps**: upgrade libuv to 1.10.2 (cjihrig) [#10717](https://github.com/nodejs/node/pull/10717)
* [[`fcf47518f7`](https://github.com/nodejs/node/commit/fcf47518f7)] - **(SEMVER-MINOR)** **deps**: upgrade libuv to 1.10.1 (cjihrig) [#9647](https://github.com/nodejs/node/pull/9647)
* [[`2a067522f7`](https://github.com/nodejs/node/commit/2a067522f7)] - **(SEMVER-MINOR)** **deps**: upgrade libuv to 1.10.0 (cjihrig) [#9267](https://github.com/nodejs/node/pull/9267)
* [[`ef51f70d55`](https://github.com/nodejs/node/commit/ef51f70d55)] - **(SEMVER-MINOR)** **dns**: implement {ttl: true} for dns.resolve6() (Ben Noordhuis) [#9296](https://github.com/nodejs/node/pull/9296)
* [[`d9a77bd1a3`](https://github.com/nodejs/node/commit/d9a77bd1a3)] - **(SEMVER-MINOR)** **dns**: implement {ttl: true} for dns.resolve4() (Ben Noordhuis) [#9296](https://github.com/nodejs/node/pull/9296)
* [[`0a1dbcb035`](https://github.com/nodejs/node/commit/0a1dbcb035)] - **doc**: linkify type\[\] syntax, support lowercase for primitives (Roman Reiss) [#11167](https://github.com/nodejs/node/pull/11167)
* [[`99ebb9aadb`](https://github.com/nodejs/node/commit/99ebb9aadb)] - **doc**: consistent case for primitive types (Roman Reiss) [#11167](https://github.com/nodejs/node/pull/11167)
* [[`3ceab64820`](https://github.com/nodejs/node/commit/3ceab64820)] - **doc**: fix an unclear wording in readline.md (Vse Mozhet Byt) [#12605](https://github.com/nodejs/node/pull/12605)
* [[`c0d92d71b0`](https://github.com/nodejs/node/commit/c0d92d71b0)] - **doc**: fix typo in doc/api/process.md (morrme) [#12612](https://github.com/nodejs/node/pull/12612)
* [[`a443e33d78`](https://github.com/nodejs/node/commit/a443e33d78)] - **doc**: make commit guidelines easier to reference (Benjamin Fleischer) [#11732](https://github.com/nodejs/node/pull/11732)
* [[`8bca7111c8`](https://github.com/nodejs/node/commit/8bca7111c8)] - **doc**: add suggestion to use --3way (Michael Dawson) [#12510](https://github.com/nodejs/node/pull/12510)
* [[`828f71414c`](https://github.com/nodejs/node/commit/828f71414c)] - **doc**: update link to Code of Conduct (Alex Autem) [#12552](https://github.com/nodejs/node/pull/12552)
* [[`857d0a1689`](https://github.com/nodejs/node/commit/857d0a1689)] - **doc**: add lucamaraschi to collaborators (Luca Maraschi) [#12538](https://github.com/nodejs/node/pull/12538)
* [[`99ab18a16b`](https://github.com/nodejs/node/commit/99ab18a16b)] - **doc**: unify spaces in a querystring.md code example (Vse Mozhet Byt) [#12465](https://github.com/nodejs/node/pull/12465)
* [[`c81221b38b`](https://github.com/nodejs/node/commit/c81221b38b)] - **doc**: run tests before landing changes (Rich Trott) [#12416](https://github.com/nodejs/node/pull/12416)
* [[`6068bb7370`](https://github.com/nodejs/node/commit/6068bb7370)] - **doc**: avoid colloquialism (Rich Trott) [#12417](https://github.com/nodejs/node/pull/12417)
* [[`c4a98e41bd`](https://github.com/nodejs/node/commit/c4a98e41bd)] - **doc**: fix encoding string in buffer example (MapleUncle) [#12482](https://github.com/nodejs/node/pull/12482)
* [[`4787741393`](https://github.com/nodejs/node/commit/4787741393)] - **doc**: correct git fix whitespace command (Mateusz Konieczny) [#12445](https://github.com/nodejs/node/pull/12445)
* [[`92451a72b9`](https://github.com/nodejs/node/commit/92451a72b9)] - **doc**: s/origin/upstream/ collaborator guide (Anna Henningsen) [#12436](https://github.com/nodejs/node/pull/12436)
* [[`bbd7b77c07`](https://github.com/nodejs/node/commit/bbd7b77c07)] - **doc**: update Mac OS X references in releases.md (JR McEntee) [#12106](https://github.com/nodejs/node/pull/12106)
* [[`a0fce164db`](https://github.com/nodejs/node/commit/a0fce164db)] - **doc**: correct markdown file line lengths (JR McEntee) [#12106](https://github.com/nodejs/node/pull/12106)
* [[`0b22f4a528`](https://github.com/nodejs/node/commit/0b22f4a528)] - **doc**: change Mac OS X to macOS (JR McEntee) [#12106](https://github.com/nodejs/node/pull/12106)
* [[`5e2d198d3e`](https://github.com/nodejs/node/commit/5e2d198d3e)] - **doc**: add missing ) in CONTRIBUTING.md (Mateusz Konieczny) [#12444](https://github.com/nodejs/node/pull/12444)
* [[`d08b37981c`](https://github.com/nodejs/node/commit/d08b37981c)] - **doc**: add guide for backporting prs (Evan Lucas) [#11099](https://github.com/nodejs/node/pull/11099)
* [[`da253fe6e6`](https://github.com/nodejs/node/commit/da253fe6e6)] - **doc**: update link for landing PRs (Rich Trott) [#12415](https://github.com/nodejs/node/pull/12415)
* [[`e082070b6d`](https://github.com/nodejs/node/commit/e082070b6d)] - **doc**: add DavidCai1993 to collaborators (David Cai) [#12435](https://github.com/nodejs/node/pull/12435)
* [[`af00d761bf`](https://github.com/nodejs/node/commit/af00d761bf)] - **doc**: fix typo in streams.md (John Paul Bamberg) [#12428](https://github.com/nodejs/node/pull/12428)
* [[`a8436d95bf`](https://github.com/nodejs/node/commit/a8436d95bf)] - **doc**: add jkrems to collaborators (Jan Krems) [#12427](https://github.com/nodejs/node/pull/12427)
* [[`1370c5add6`](https://github.com/nodejs/node/commit/1370c5add6)] - **doc**: path functions ignore trailing slashes (Tobias Nießen) [#12181](https://github.com/nodejs/node/pull/12181)
* [[`5a0aef5038`](https://github.com/nodejs/node/commit/5a0aef5038)] - **doc**: add info about serializable types (Shubheksha Jalan) [#12313](https://github.com/nodejs/node/pull/12313)
* [[`d46f763860`](https://github.com/nodejs/node/commit/d46f763860)] - **doc**: fix formatting in onboarding-extras (Rich Trott) [#12350](https://github.com/nodejs/node/pull/12350)
* [[`9d2a5fb470`](https://github.com/nodejs/node/commit/9d2a5fb470)] - **doc**: response.write ignores body in some cases (Ruslan Bekenev) [#12314](https://github.com/nodejs/node/pull/12314)
* [[`570d6ed39a`](https://github.com/nodejs/node/commit/570d6ed39a)] - **doc**: add AnnaMag to collaborators (AnnaMag) [#12414](https://github.com/nodejs/node/pull/12414)
* [[`7d6767892b`](https://github.com/nodejs/node/commit/7d6767892b)] - **doc**: limit lines to 80 cols in internal README (Evan Lucas) [#12358](https://github.com/nodejs/node/pull/12358)
* [[`2fc806e27b`](https://github.com/nodejs/node/commit/2fc806e27b)] - **doc**: add single arg scenario for util.format (Tarun Batra) [#12374](https://github.com/nodejs/node/pull/12374)
...
* [[`4b8c6ddc2a`](https://github.com/nodejs/node/commit/4b8c6ddc2a)] - **fs**: re-enable watch facility in AIX (Gireesh Punathil) [#10085](https://github.com/nodejs/node/pull/10085)
* [[`4ab88a021f`](https://github.com/nodejs/node/commit/4ab88a021f)] - **lib**: fix typo in comments in module.js (WORMSS) [#12528](https://github.com/nodejs/node/pull/12528)
* [[`195263ef27`](https://github.com/nodejs/node/commit/195263ef27)] - **meta**: update authors list (Aashil Patel) [#11533](https://github.com/nodejs/node/pull/11533)
* [[`689e678287`](https://github.com/nodejs/node/commit/689e678287)] - **meta**: move the Code of Conduct to TSC repository (James M Snell) [#12147](https://github.com/nodejs/node/pull/12147)
* [[`c906f5c137`](https://github.com/nodejs/node/commit/c906f5c137)] - **net**: refactor onSlaveClose in Server.close (Claudio Rodriguez) [#12334](https://github.com/nodejs/node/pull/12334)
* [[`846270f899`](https://github.com/nodejs/node/commit/846270f899)] - **(SEMVER-MINOR)** **process**: add NODE_NO_WARNINGS environment variable (cjihrig) [#10842](https://github.com/nodejs/node/pull/10842)
...
* [[`5bbe2f6170`](https://github.com/nodejs/node/commit/5bbe2f6170)] - **readline**: rename `deDupeHistory` option (Danny Nemer) [#11950](https://github.com/nodejs/node/pull/11950)
* [[`d3dafd6ed1`](https://github.com/nodejs/node/commit/d3dafd6ed1)] - **(SEMVER-MINOR)** **readline**: add option to stop duplicates in history (Danny Nemer) [#2982](https://github.com/nodejs/node/pull/2982)
* [[`b0a6e67ad6`](https://github.com/nodejs/node/commit/b0a6e67ad6)] - ***Revert*** "**repl**: disable Ctrl+C support on win32 for now" (Anna Henningsen) [#8645](https://github.com/nodejs/node/pull/8645)
* [[`604e485bd6`](https://github.com/nodejs/node/commit/604e485bd6)] - **src**: remove invalid comment (cjihrig) [#12645](https://github.com/nodejs/node/pull/12645)
* [[`e9cee1a5bd`](https://github.com/nodejs/node/commit/e9cee1a5bd)] - **src**: remove TODO about uv errno removal (Daniel Bevenius) [#12536](https://github.com/nodejs/node/pull/12536)
* [[`276f3e6885`](https://github.com/nodejs/node/commit/276f3e6885)] - **(SEMVER-MINOR)** **src**: add SafeGetenv() to internal API (Sam Roberts) [#11006](https://github.com/nodejs/node/pull/11006)
* [[`dc7cbf629c`](https://github.com/nodejs/node/commit/dc7cbf629c)] - **src**: make copies of startup environment variables (Ben Noordhuis) [#11051](https://github.com/nodejs/node/pull/11051)
* [[`0ff639476d`](https://github.com/nodejs/node/commit/0ff639476d)] - **(SEMVER-MINOR)** **src**: support "--" after "-e" as end-of-options (John Barboza) [#10651](https://github.com/nodejs/node/pull/10651)
...
* [[`4e8399ff9f`](https://github.com/nodejs/node/commit/4e8399ff9f)] - **test**: add mustCall in test-timers-clearImmediate (Zahidul Islam) [#12598](https://github.com/nodejs/node/pull/12598)
* [[`0d800625c9`](https://github.com/nodejs/node/commit/0d800625c9)] - **test**: use block scoped variable names (Neehar Venugopal) [#12544](https://github.com/nodejs/node/pull/12544)
* [[`c76de64aa4`](https://github.com/nodejs/node/commit/c76de64aa4)] - **test**: dynamic port in cluster eaddrinuse (Sebastian Plesciuc) [#12547](https://github.com/nodejs/node/pull/12547)
* [[`b753e92819`](https://github.com/nodejs/node/commit/b753e92819)] - **test**: dynamic port in cluster ipc throw (Sebastian Plesciuc) [#12571](https://github.com/nodejs/node/pull/12571)
* [[`db5ffa202b`](https://github.com/nodejs/node/commit/db5ffa202b)] - **test**: replace assertion error check with regex (thelady) [#12603](https://github.com/nodejs/node/pull/12603)
* [[`bfb209bb93`](https://github.com/nodejs/node/commit/bfb209bb93)] - **test**: refactored context type err message to regex (Muhsin Abdul-Musawwir) [#12596](https://github.com/nodejs/node/pull/12596)
* [[`de613469d7`](https://github.com/nodejs/node/commit/de613469d7)] - **test**: improve test-process-chdir (vperezma) [#12589](https://github.com/nodejs/node/pull/12589)
* [[`fd66388b69`](https://github.com/nodejs/node/commit/fd66388b69)] - **test**: dynamic port in parallel cluster tests (Sebastian Plesciuc) [#12584](https://github.com/nodejs/node/pull/12584)
* [[`0910733195`](https://github.com/nodejs/node/commit/0910733195)] - **test**: dynamic port in cluster worker dgram (Sebastian Plesciuc) [#12487](https://github.com/nodejs/node/pull/12487)
* [[`234e44cc18`](https://github.com/nodejs/node/commit/234e44cc18)] - **test**: move test-debugger-repeat-last to sequential (kumarrishav) [#12470](https://github.com/nodejs/node/pull/12470)
* [[`57f8f27345`](https://github.com/nodejs/node/commit/57f8f27345)] - **test**: use duplex streams in duplex stream test (cjihrig) [#12514](https://github.com/nodejs/node/pull/12514)
* [[`c9c7911587`](https://github.com/nodejs/node/commit/c9c7911587)] - **test**: use JSON.stringify to trigger stack overflow (Yang Guo) [#12481](https://github.com/nodejs/node/pull/12481)
* [[`7cfa06390d`](https://github.com/nodejs/node/commit/7cfa06390d)] - **test**: console.log removed from test-net-localport (Faiz Halde) [#12483](https://github.com/nodejs/node/pull/12483)
* [[`3e190b2a4e`](https://github.com/nodejs/node/commit/3e190b2a4e)] - **test**: dynamic port in cluster worker disconnect (Sebastian Plesciuc) [#12457](https://github.com/nodejs/node/pull/12457)
* [[`9ea65bf2b9`](https://github.com/nodejs/node/commit/9ea65bf2b9)] - **test**: remove uses of common.PORT in test-tls-client tests (Ahmed Taj elsir) [#12461](https://github.com/nodejs/node/pull/12461)
* [[`d3f28ee35e`](https://github.com/nodejs/node/commit/d3f28ee35e)] - **test**: dynamic port in cluster worker send (Sebastian Plesciuc) [#12472](https://github.com/nodejs/node/pull/12472)
* [[`477e41810a`](https://github.com/nodejs/node/commit/477e41810a)] - **test**: increase coverage for buffer.js (Rich Trott) [#12476](https://github.com/nodejs/node/pull/12476)
* [[`2bf9bd940c`](https://github.com/nodejs/node/commit/2bf9bd940c)] - **test**: complete coverage of lib/child_process.js (cjihrig) [#12367](https://github.com/nodejs/node/pull/12367)
* [[`da68b13b4e`](https://github.com/nodejs/node/commit/da68b13b4e)] - **test**: buffer should always be stringified (Luca Maraschi) [#12355](https://github.com/nodejs/node/pull/12355)
* [[`fcfe7aec2f`](https://github.com/nodejs/node/commit/fcfe7aec2f)] - **test**: use dynamic port in test-cluster-bind-twice (Rich Trott) [#12418](https://github.com/nodejs/node/pull/12418)
* [[`08833f3fc8`](https://github.com/nodejs/node/commit/08833f3fc8)] - **test**: remove common.PORT from test-cluster*.js (Tarun Batra) [#12441](https://github.com/nodejs/node/pull/12441)
* [[`a62033cd1a`](https://github.com/nodejs/node/commit/a62033cd1a)] - **test**: use dynamic port in 3 test-cluster-worker tests (Sebastian Plesciuc) [#12443](https://github.com/nodejs/node/pull/12443)
* [[`5f790ebec0`](https://github.com/nodejs/node/commit/5f790ebec0)] - **test**: add --use-bundled-ca to tls-cnnic-whitelist (Daniel Bevenius) [#12394](https://github.com/nodejs/node/pull/12394)
* [[`e68f2b9419`](https://github.com/nodejs/node/commit/e68f2b9419)] - **test**: add crypto check to crypto-lazy-transform (Daniel Bevenius) [#12424](https://github.com/nodejs/node/pull/12424)
* [[`3a91159348`](https://github.com/nodejs/node/commit/3a91159348)] - **(SEMVER-MINOR)** **test**: make tls-socket-default-options tests run (Sam Roberts) [#11005](https://github.com/nodejs/node/pull/11005)
* [[`23c55d6cba`](https://github.com/nodejs/node/commit/23c55d6cba)] - **test**: remove common.PORT from test-cluster-basic (Rich Trott) [#12377](https://github.com/nodejs/node/pull/12377)
* [[`03cb721ebc`](https://github.com/nodejs/node/commit/03cb721ebc)] - **test**: add hasCrypto check to test-debug-usage (Daniel Bevenius) [#12357](https://github.com/nodejs/node/pull/12357)
* [[`9baaff7ae7`](https://github.com/nodejs/node/commit/9baaff7ae7)] - **test**: improve punycode coverage to check surrogate pair (Nao YONASHIRO) [#12354](https://github.com/nodejs/node/pull/12354)
* [[`51d9806771`](https://github.com/nodejs/node/commit/51d9806771)] - **test**: cleanup test-fs-watch.js (RobotMermaid) [#12595](https://github.com/nodejs/node/pull/12595)
* [[`011b55d9d0`](https://github.com/nodejs/node/commit/011b55d9d0)] - **test**: remove flaky designation for test on AIX (Rich Trott) [#12564](https://github.com/nodejs/node/pull/12564)
...
* [[`f5938ef30a`](https://github.com/nodejs/node/commit/f5938ef30a)] - **(SEMVER-MINOR)** **tls**: new tls.TLSSocket() supports sec ctx options (Sam Roberts) [#11005](https://github.com/nodejs/node/pull/11005)
* [[`83e856776c`](https://github.com/nodejs/node/commit/83e856776c)] - **(SEMVER-MINOR)** **tls**: allow obvious key/passphrase combinations (Sam Roberts) [#10294](https://github.com/nodejs/node/pull/10294)
* [[`5fd159360f`](https://github.com/nodejs/node/commit/5fd159360f)] - **tools**: fix lint issue in doctool (Roman Reiss) [#11658](https://github.com/nodejs/node/pull/11658)
* [[`98dea69d53`](https://github.com/nodejs/node/commit/98dea69d53)] - **tools**: use no-useless-concat ESLint rule (Vse Mozhet Byt) [#12613](https://github.com/nodejs/node/pull/12613)
* [[`8ce09a717d`](https://github.com/nodejs/node/commit/8ce09a717d)] - **tools**: enable no-useless-return eslint rule (cjihrig) [#12577](https://github.com/nodejs/node/pull/12577)
* [[`3dad38e453`](https://github.com/nodejs/node/commit/3dad38e453)] - **tools**: add `root: true` in main .eslintrc.yaml (Vse Mozhet Byt) [#12570](https://github.com/nodejs/node/pull/12570)
...
* [[`3fd009e848`](https://github.com/nodejs/node/commit/3fd009e848)] - **url**: improve descriptiveness of identifier (Rich Trott) [#12579](https://github.com/nodejs/node/pull/12579)
* [[`72fe2b8f8b`](https://github.com/nodejs/node/commit/72fe2b8f8b)] - **v8**: fix stack overflow in recursive method (Ben Noordhuis) [#12460](https://github.com/nodejs/node/pull/12460)
* [[`c6060fa332`](https://github.com/nodejs/node/commit/c6060fa332)] - ***Revert*** "**v8**: drop v8::FunctionCallbackInfo\<T\>::NewTarget()" (Ben Noordhuis)
